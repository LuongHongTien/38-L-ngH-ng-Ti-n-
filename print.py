...
def add_student(name, year_of_birth, address):
    ...
    if __main__=="__main__":
        print("---CHƯƠNG TRÌNH QUẢN LÍ SINH VIÊN---")
        print("\n1. Thêm sinh viên:")
        add_student("Nguyễn Văn An", 2003, "Đà Nẵng")
        add_student("Trần Thị Bình", 2002, "Quảng Ngãi")
        add_student("Lê VĂn Hùng", 2003, "Huế")
    ...
    if not student_list:
        print("Danh sách trống")
            ...
            for sv in student_list:
                print(f"-Tên:" {sv['name']}, Năm sinh: {sv['year_of_birth']}Địa chỉ {sv['address']})
                if __main__== "__main__":
                    print("---CHƯƠNG TRÌNH QUẢN LÍ SINH VIÊN---")
                    print("\n1.Thêm sinh viên:")
                     add_student("Nguyễn Văn An", 2003, "Đà Nẵng")
